...
def define_inner_layout(fig, buttons, filter_options, map_layout_dict, language="en", project_name=None):
    return html.Div(
        [
            ...
            # Side menu
            define_menu(buttons, filter_options, language=language, project_name=project_name),
