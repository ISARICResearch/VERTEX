...
from isaricanalytics.utils import strip_html, strip_nonstandard_unicode_chars
from isaricanalytics.redcap_data import getRC
import pandas as pd
...
def get_project_data(project_path: str | Path) -> dict[str, typing.Any]:
    ...
    if not isinstance(_project_path, Path):
        _project_path = Path(_project_path).resolve()
