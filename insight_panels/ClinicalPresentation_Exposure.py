...
def create_visuals(df_map):
    ...
    table, table_key = ia.reformat_descriptive_table(
        ...
        column_reorder=column_reorder, section_reorder=None)
    ...
    proportions = ia.get_proportions(df_map[inclu_columns], ['expo14'])
    ...
    upset_plot = idw.fig_upset(
        ...
        title='Intersection sizes of the five most common exposure in past 14 days',
        graph_id='upset_' + suffix,
        graph_label='Exposure: Intersections',
        graph_about='Intersection sizes of the five most common exposure')
