...
def create_visuals(df_map):
    ...
    proportions, set_data = ia.get_proportions(df_map[inclu_columns], 'compl')
    ...
    upset_plot = idw.fig_upset(
        ...
        title='Frequency of combinations of the five most common complications',
        graph_id='upset_compl_' + suffix,
        graph_label='Complications: Intersections',
        graph_about='Frequency of combinations of the five most common complications')
