...
def create_df_map(redcap_url, redcap_api_key, site_mapping):
...
def create_visuals(df_map):
    ...
    # variable_dict = getRC.getVaribleType(dd)
    ...
    fig1 = idw.fig_placeholder(
        df_map, graph_id='fig1_id' + suffix, graph_label='Figure 1')
    fig2 = idw.fig_placeholder(
        df_map, graph_id='fig2_id' + suffix, graph_label='Figure 2')
    return fig1, fig2
...
df_map = create_df_map(redcap_url, redcap_api_key, site_mapping)
