...
def define_button():
    ...
    button_item = "Analyses initiales"
    button_label = "Toutes les données"
...
def create_visuals(df_map, df_forms_dict, dictionary, quality_report, filepath, suffix, save_inputs):
    ...
    df_table = ia.get_descriptive_data(df_map, dictionary, by_column=split_column, include_sections=sections)
    ...
    fig_table = idw.fig_table(
        ...
        graph_label="Tableau descriptif",
        graph_about="Résumé de toutes les données.",
    )
