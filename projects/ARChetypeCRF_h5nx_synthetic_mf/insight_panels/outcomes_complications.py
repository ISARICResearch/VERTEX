...
def create_visuals(df_map, df_forms_dict, dictionary, quality_report, filepath, suffix, save_inputs):
    ...
    new_variable_dict = {
        ...
        "form_name": "outcome",
        "field_type": "numeric",
        "field_label": "Length of stay",
        "parent": "outco",
    }
    dictionary = ia.extend_dictionary(dictionary, new_variable_dict, df_map)
    ...
    df_table = ia.get_descriptive_data(df_map, dictionary, by_column=split_column, include_sections=["outco", "compl"])
