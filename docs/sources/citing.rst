...
VERTEX is **published** on `GitHub <https://github.com/ISARICResearch/VERTEX/releases>`_ and `Zenodo <https://zenodo.org/records/19609674>`_. It has the DOI:

`10.5281/zenodo.14170824 <https://doi.org/10.5281/zenodo.14170824>`_
